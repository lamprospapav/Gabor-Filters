...
gaborResult = zeros(20,20,size(gaborArray,3));

gaborArray = rot90(gaborArray);
gaborArray = rot90(gaborArray);

for i=1:size(gaborArray,3)
    gaborResult(:,:,i) = conv2(img,(gaborArray(:,:,i)),'valid');
    gaborResult(:,:,i) = abs(gaborResult(:,:,i));
end
